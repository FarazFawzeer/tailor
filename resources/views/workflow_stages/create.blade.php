@extends('layouts.vertical', ['subtitle' => 'Workflow Stage Create'])

@section('content')
    @include('layouts.partials.page-title', ['title' => 'Workflow Stages', 'subtitle' => 'Create'])
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="createStageForm" action="{{ route('workflow-stages.store') }}" method="POST">
                @csrf
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('workflow-stages.index') }}" class="btn btn-secondary" style="width: 120px;">Back</a>
