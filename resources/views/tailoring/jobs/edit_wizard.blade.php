...
@section('content')
    ...
    <div class="card mb-3">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="muted-help">
                        Job: <b>{{ $job->job_no }}</b> → Edit Batches → Edit Items → Measurements → Update once
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <form id="wizardForm" action="{{ route('tailoring.jobs.updateWizard', $job) }}" method="POST">
                @csrf
                @method('PUT')
    ...
    <script>
        ...
        document.getElementById('wizardForm').addEventListener('submit', function(e) {
            ...
            fetch(this.action, {
                ...
                setTimeout(() => {
                    window.location.href = "{{ route('tailoring.jobs.show', $job) }}";
                }, 700);
