@extends('layouts.vertical', ['subtitle' => 'Dress Type Create'])

@section('content')
    @include('layouts.partials.page-title', ['title' => 'Dress Types', 'subtitle' => 'Create'])
...
<form id="createDressTypeForm" action="{{ route('dress-types.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
