@extends('layouts.vertical', ['subtitle' => 'Hire Item Create'])

@section('content')
    @include('layouts.partials.page-title', ['title' => 'Hiring Inventory', 'subtitle' => 'Create'])
    ...
    <div class="card report-card">
        ...
        <div class="card-body">
            ...
            <form id="createHireItemForm" action="{{ route('hiring.items.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="sticky-actions mt-4">
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('hiring.items.index') }}" class="btn btn-secondary">Back</a>
