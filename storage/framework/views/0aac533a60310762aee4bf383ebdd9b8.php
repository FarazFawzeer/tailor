...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.partials.page-title', ['title' => 'Hiring', 'subtitle' => 'Return Items'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="card report-card">
        <div class="card-header d-flex align-items-start justify-content-between">
            <div>
                <h5 class="card-title mb-0">Return Items - <?php echo e($agreement->agreement_no); ?></h5>
                <div class="muted-help mt-1">
                    Customer: <b><?php echo e($agreement->customer?->full_name ?? 'N/A'); ?></b>
                    <span class="text-muted">|</span>
                    Status: <span class="badge <?php echo e($statusBadge); ?>"><?php echo e(ucfirst($agreement->status)); ?></span>
                </div>
            </div>

            <a href="<?php echo e(route('hiring.agreements.show', $agreement)); ?>"
            ...
            <div class="row g-2 mb-3">
                <div class="col-md-4">
                    <div class="kpi">
                        ...
                        <div class="val"><?php echo e(optional($expected)->format('d M Y') ?? '-'); ?></div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="kpi">
                        <div class="label">Fine Per Day</div>
                        <div class="val">Rs <?php echo e(number_format($finePerDay, 2)); ?></div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="kpi">
                        <div class="label">Agreement Items</div>
                        <div class="val"><?php echo e($lines->count()); ?> lines (Qty: <?php echo e($totalQty); ?>)</div>
            ...
            <div class="card border mb-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-muted small">
                        Hire Total: <b>Rs <?php echo e(number_format($hireTotal, 2)); ?></b>
                    </div>
                </div>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $agreement->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-light text-dark border"><?php echo e($ai->size ?? '-'); ?></span>
                                        </td>
                ...
                <div class="card border mb-3">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-light text-dark border">
                            Pending (Before Fine): Rs <span id="pendingAmtText"><?php echo e(number_format($pendingBeforeFine, 2)); ?></span>
                        </span>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row g-2">
                            ...
                            <div class="col-md-3">
                                <div class="kpi">
                                    ...
                                    <div class="val">Rs <?php echo e(number_format($deposit, 2)); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="kpi">
                                    ...
                                    <div class="val">Rs <?php echo e(number_format($paid, 2)); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="kpi">
                                    ...
                                    <div class="val text-danger">Rs <?php echo e(number_format($pendingBeforeFine, 2)); ?></div>
                        ...
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" min="0"
                                       ...
                                       value="<?php echo e($pendingBeforeFine > 0 ? number_format($pendingBeforeFine, 2, '.', '') : '0.00'); ?>">
                        ...
                        <input type="hidden" id="pendingBeforeFine" value="<?php echo e(number_format($pendingBeforeFine, 2, '.', '')); ?>">
                    </div>
                </div>
    ...
    <script>
        document.getElementById('returnForm').addEventListener('submit', function(e) {
            ...
            Swal.fire({
                ...
                fetch("<?php echo e(route('hiring.agreements.return.store', $agreement)); ?>", {
                    method: "POST",
                    body: fd,
                    headers: {
                    ...
                    setTimeout(() => window.location.href = "<?php echo e(route('hiring.agreements.show', $agreement)); ?>", 900);
                }).catch(() => {
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => 'Return Items'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Personal Projects\Infotech\tailor\resources\views/hiring/agreements/return.blade.php ENDPATH**/ ?>