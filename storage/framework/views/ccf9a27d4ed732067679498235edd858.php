        ...
        <div class="card-body">
            ...
            <form id="wizardForm" action="<?php echo e(route('tailoring.jobs.updateWizard', $job)); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="notes" class="form-control" rows="2" placeholder="Optional notes for this job"><?php echo e($job->notes); ?></textarea>
                </div>

                <div class="col-md-3 mb-3">
                    <label class="form-label">Discount</label>
                    <input type="number" step="0.01" min="0" name="discount" class="form-control"
                        value="<?php echo e($job->discount ?? 0); ?>">
                </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-3">
                    <a href="<?php echo e(route('tailoring.jobs.show', $job)); ?>" class="btn btn-secondary"
