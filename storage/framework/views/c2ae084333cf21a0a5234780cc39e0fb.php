...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.partials.page-title', ['title' => 'Hiring', 'subtitle' => 'Create Agreement'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="card report-card">
        ...
        <div class="card-body">
            ...
            <form id="agreementForm" action="<?php echo e(route('hiring.agreements.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input name="agreement_no" class="form-control" value="<?php echo e($agreementNo); ?>" readonly>
                    </div>
                        ...
                        <select name="customer_id" class="form-select" required>
                            ...
                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($c->id); ?>">
                                    <?php echo e($c->full_name); ?> <?php echo e($c->phone ? ' - '.$c->phone : ''); ?>
                ...
                <div class="card border mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-2" id="availableGrid">
                            <?php $__currentLoopData = $availableItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="col-md-3 item-wrap"
                                    ...
                                    data-code="<?php echo e(strtolower($it->item_code)); ?>"
                                    data-name="<?php echo e(strtolower($it->name)); ?>"
                                    data-category="<?php echo e($cat); ?>"
                                    data-price="<?php echo e((float)$it->hire_price); ?>"
                                    data-deposit="<?php echo e((float)($it->deposit_amount ?? 0)); ?>"
                                    data-code-original="<?php echo e($it->item_code); ?>"
                                    data-name-original="<?php echo e($it->name); ?>"
                                    data-thumb="<?php echo e($thumb); ?>"
                                    data-variants='<?php echo json_encode($variants->map(fn($v)=>["size"=>$v->size, "qty"=>(int)$v->qty])->values(), 512) ?>'
                                >
                                    <div class="item-card p-2 h-100">
                                        <div class="d-flex gap-2 align-items-center">
                                            <img src="<?php echo e($thumb); ?>" class="thumb" alt="img">
                                            <div class="flex-grow-1">
                                                <div class="fw-bold"><?php echo e($it->item_code); ?></div>
                                                <div class="small text-muted"><?php echo e($it->name); ?></div>
                                                <div class="small">Rs <?php echo e(number_format((float)$it->hire_price, 2)); ?></div>
                                            </div>
                                        </div>
                ...
                <div class="sticky-actions">
                    <div class="d-flex justify-content-end gap-2">
                        <a href="<?php echo e(route('hiring.agreements.index')); ?>" class="btn btn-secondary big-btn" style="width: 120px;">Back</a>
    ...
    <script>
        ...
        document.getElementById('agreementForm').addEventListener('submit', function(e) {
            ...
            fetch(form.action, {
                ...
                setTimeout(() => window.location.href = "<?php echo e(route('hiring.agreements.index')); ?>", 900);
            }).catch(() => {
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => 'Hire Agreement Create'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Personal Projects\Infotech\tailor\resources\views/hiring/agreements/create.blade.php ENDPATH**/ ?>