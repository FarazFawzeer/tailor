                    ...
                    <div class="card border-0 shadow-lg">
                        <div class="card-body p-5">
                            <div class="text-center">
                                <div class="mx-auto mb-4 text-center auth-logo">
                                    <a href="#" class="logo-dark">
                                        <img src="/images/logo.png" height="100" width="200" alt="logo dark">
                                    </a>
                                    <a href="#" class="logo-light">
                                        <img src="/images/logo.png" height="50" alt="logo light">
                                    </a>
                                </div>
                            ...
                            <form action="<?php echo e(route('login')); ?>" method="POST" class="mt-4">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="username" value="<?php echo e(Auth::user()?->email); ?>">
...
<?php echo $__env->make('layouts.base', ['subtitle' => 'Lock Screen'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Personal Projects\Infotech\tailor\resources\views/auth/lock-screen.blade.php ENDPATH**/ ?>