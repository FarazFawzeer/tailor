...
<head>
    <meta charset="utf-8">
    <title>Invoice - <?php echo e($agreement->agreement_no); ?></title>
    <style>
...
<body>
    ...
    <table>
        <tr>
            <td style="width:60%;">
                <div class="h1"><?php echo e($companyName); ?></div>
                <div class="muted" style="line-height:1.6; margin-top:6px;">
                    <?php if($companyAddr): ?> <?php echo e($companyAddr); ?> <br><?php endif; ?>
                    <?php if($companyPhone): ?> Phone: <?php echo e($companyPhone); ?> <?php endif; ?>
                </div>
            </td>
            <td class="text-right" style="width:40%;">
                <div class="title">INVOICE</div>
                <div class="muted" style="margin-top:6px; line-height:1.6;">
                    Invoice No: <span class="bold"><?php echo e($agreement->agreement_no); ?></span><br>
                    Status: <span class="bold"><?php echo e($status); ?></span><br>
                    Issue Date: <span class="bold"><?php echo e($issue ?? '-'); ?></span><br>
                    Due (Return): <span class="bold"><?php echo e($due ?? '-'); ?></span>
                </div>
            </td>
        </tr>
    </table>
    ...
    <div class="box">
        ...
        <div class="bold" style="font-size:14px; margin-top:4px;">
            <?php echo e($agreement->customer?->full_name ?? 'N/A'); ?>

        </div>
        <div class="muted" style="line-height:1.6; margin-top:4px;">
            <?php if($agreement->customer?->phone): ?> Phone: <?php echo e($agreement->customer->phone); ?><br><?php endif; ?>
            <?php if($agreement->customer?->email): ?> Email: <?php echo e($agreement->customer->email); ?><br><?php endif; ?>
        </div>
    </div>
        ...
        <tr>
            <td style="width:33.33%; padding-right:8px;">
                <div class="kpi">
                    ...
                    <div class="v"><?php echo e($totalQty); ?></div>
                </div>
            </td>
            <td style="width:33.33%; padding:0 8px;">
                <div class="kpi">
                    <div class="l">Fine / Day</div>
                    <div class="v"><?php echo e($currency); ?> <?php echo e(number_format($finePerDay,2)); ?></div>
                </div>
            </td>
            <td style="width:33.33%; padding-left:8px;">
                <div class="kpi">
                    <div class="l">Balance Payable</div>
                    <div class="v"><?php echo e($currency); ?> <?php echo e(number_format($balance,2)); ?></div>
                </div>
            </td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tbody>
            <?php $__currentLoopData = $lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <tr>
                    <td>
                        <div class="bold"><?php echo e($ai->item?->name ?? 'N/A'); ?></div>
                        <div class="muted" style="font-size:11px;"><?php echo e($ai->item?->category ?? ''); ?></div>
                    </td>
                    <td class="bold"><?php echo e($ai->item?->item_code ?? '-'); ?></td>
                    <td><span class="badge"><?php echo e($ai->size ?? '-'); ?></span></td>
                    <td class="text-right"><?php echo e($currency); ?> <?php echo e(number_format($price,2)); ?></td>
                    <td class="text-right bold"><?php echo e($qty); ?></td>
                    <td class="text-right bold"><?php echo e($currency); ?> <?php echo e(number_format($lt,2)); ?></td>
                </tr>
                ...
                <td style="width:55%; vertical-align:top;">
                    <div class="box">
                        ...
                        <div class="muted" style="margin-top:6px; line-height:1.7;">
                            ...
                            • Fine Per Day: <span class="bold"><?php echo e($currency); ?> <?php echo e(number_format($finePerDay,2)); ?></span><br>
                            • Total Qty: <span class="bold"><?php echo e($totalQty); ?></span>
                        </div>

                        <?php if($agreement->notes): ?>
                            <div class="hr"></div>
                            <div class="muted"><span class="bold">Notes:</span> <?php echo e($agreement->notes); ?></div>
                        <?php endif; ?>
                    </div>
                </td>
                    ...
                    <div class="box">
                        <table>
                            <tr>
                                ...
                                <td class="text-right bold"><?php echo e($currency); ?> <?php echo e(number_format($subTotal,2)); ?></td>
                            </tr>
                            <tr>
                                <td class="muted">Fine</td>
                                <td class="text-right bold"><?php echo e($currency); ?> <?php echo e(number_format($fineNow,2)); ?></td>
                            </tr>
                            <tr>
                                <td class="muted">Grand Total</td>
                                <td class="text-right bold"><?php echo e($currency); ?> <?php echo e(number_format($grandTotal,2)); ?></td>
                            </tr>
                            <tr>
                                <td class="muted">Deposit Received</td>
                                <td class="text-right bold">- <?php echo e($currency); ?> <?php echo e(number_format($depositReceived,2)); ?></td>
                            </tr>
                            <tr>
                                <td class="muted">Paid So Far</td>
                                <td class="text-right bold">- <?php echo e($currency); ?> <?php echo e(number_format($paidSoFar,2)); ?></td>
                            </tr>
                            <tr class="total-row">
                                <td class="bold">Balance Payable</td>
                                <td class="text-right bigTotal"><?php echo e($currency); ?> <?php echo e(number_format($balance,2)); ?></td>
                            </tr>
                        </table>
                    </div>
                </td>
...
</html><?php /**PATH F:\Personal Projects\Infotech\tailor\resources\views/hiring/agreements/invoice_pdf.blade.php ENDPATH**/ ?>